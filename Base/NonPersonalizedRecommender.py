...
class TopPop(BaseRecommender):
    ...
    def __init__(self, URM_train, evaluation_block_size: int = 500):
        super(TopPop, self).__init__(URM_train, evaluation_block_size=evaluation_block_size)
...
class Random(BaseRecommender):
    ...
    def __init__(self, URM_train, evaluation_block_size: int = 1500):
        super(Random, self).__init__(URM_train, evaluation_block_size=evaluation_block_size)
