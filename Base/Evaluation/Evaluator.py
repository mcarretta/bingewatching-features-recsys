...
class Evaluator(object):
    ...
    def _parallel_compute_metrics_on_recommendation_list(self,
        ...
        """
        # If we have Elasticnet with BingeWatching URM, pop last element from recommended_items_batch_list and
        # last row and last column from scores batch
...
# /home/ec2-user/serial-content-analysis/Base/Evaluation/Evaluator.py:703: RuntimeWarning: invalid value encountered in double_scalars
#   intermediate_result_dict[cutoff][EvaluatorMetrics.NDCG.value]) division by 0?
