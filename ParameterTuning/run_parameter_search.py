...
# KNN
from KNN.UserKNNCFRecommender import UserKNNCFRecommender, UserKNNCFBingeworthyRecommender, UserKNNCFBingewatcherRecommender, UserKNNCFBingewatcherBingeworthyRecommender
from KNN.ItemKNNCFRecommender import ItemKNNCFRecommender, ItemKNNCFBingewatcherBingeworthyRecommender, ItemKNNCFBingeworthyRecommender, ItemKNNCFBingewatcherRecommender
...
from SLIM_ElasticNet.SLIMElasticNetRecommender import SLIMElasticNetRecommender, SLIMElasticNetRecommenderBingewatcherBingeworthy, SLIMElasticNetRecommenderBingewatcher, SLIMElasticNetRecommenderBingeworthy
...
from MatrixFactorization.LightFM import LightFMWrapper, LightFMWrapper_bingewatching, LightFMWrapper_bingeworthy, LightFMWrapper_bingewatching_bingeworthy
...
def run_KNNBingewatcherBingeworthyRecommender_on_similarity_type(similarity_type,
                                          parameterSearch,
                                          parameter_search_space,
                                          recommender_input_args,
                                          n_cases,
    ...
    hyperparameters_range_dictionary["similarity"] = Categorical([similarity_type])
    hyperparameters_range_dictionary["normalize"] = Categorical([True, False])
    hyperparameters_range_dictionary["weight_bingewatchers"] = Real(low=0, high=1, prior='uniform')
    hyperparameters_range_dictionary["weight_bingeworthy"] = Real(low=0, high=1, prior='uniform')
    is_set_similarity = similarity_type in ["tversky", "dice", "jaccard", "tanimoto"]
...
def run_KNNBingewatcherRecommender_on_similarity_type(similarity_type,
                                          parameterSearch,
                                          parameter_search_space,
                                          recommender_input_args,
                                          n_cases,
...
def run_KNNBingeworthyRecommender_on_similarity_type(similarity_type,
                                          parameterSearch,
                                          parameter_search_space,
                                          recommender_input_args,
                                          n_cases,
...
def runParameterSearch_Collaborative(recommender_class,
    ...
    try:
        ...
        if recommender_class in [ItemKNNCFBingewatcherBingeworthyRecommender, UserKNNCFBingewatcherBingeworthyRecommender]:
            ...
            run_KNNCFRecommender_on_similarity_type_partial = partial(run_KNNBingewatcherBingeworthyRecommender_on_similarity_type,
                                                           recommender_input_args = recommender_input_args,
                                                           parameter_search_space = {},
                                                           parameterSearch = parameterSearch,
                                                           n_cases = n_cases,
        ...
        if recommender_class in [ItemKNNCFBingewatcherRecommender, UserKNNCFBingewatcherRecommender]:
            ...
            run_KNNCFRecommender_on_similarity_type_partial = partial(run_KNNBingewatcherRecommender_on_similarity_type,
                                                           recommender_input_args = recommender_input_args,
                                                           parameter_search_space = {},
                                                           parameterSearch = parameterSearch,
                                                           n_cases = n_cases,
        ...
        if recommender_class in [ItemKNNCFBingeworthyRecommender, UserKNNCFBingeworthyRecommender]:
            ...
            run_KNNCFRecommender_on_similarity_type_partial = partial(run_KNNBingeworthyRecommender_on_similarity_type,
                                                           recommender_input_args = recommender_input_args,
                                                           parameter_search_space = {},
                                                           parameterSearch = parameterSearch,
                                                           n_cases = n_cases,
        ...
        if recommender_class is LightFMWrapper:
            hyperparameters_range_dictionary = {}
            hyperparameters_range_dictionary["item_alpha"] = Real(low=1e-4, high=1e-1, prior='log-uniform')
            hyperparameters_range_dictionary["epochs"] = Categorical([100])
            hyperparameters_range_dictionary["num_components"] = Integer(1, 350)
            recommender_input_args = SearchInputRecommenderArgs(
                CONSTRUCTOR_POSITIONAL_ARGS=[URM_train],
                CONSTRUCTOR_KEYWORD_ARGS={},
                FIT_POSITIONAL_ARGS=[],
        ...
        if recommender_class is LightFMWrapper_bingewatching_bingeworthy:
            hyperparameters_range_dictionary = {}
            hyperparameters_range_dictionary["item_alpha"] = Real(low=1e-4, high=1e-1, prior='log-uniform')
            hyperparameters_range_dictionary["epochs"] = Categorical([100])
            hyperparameters_range_dictionary["num_components"] = Integer(1, 350)
        ...
        if recommender_class is LightFMWrapper_bingewatching:
            hyperparameters_range_dictionary = {}
            hyperparameters_range_dictionary["item_alpha"] = Real(low=1e-4, high=1e-1, prior='log-uniform')
            hyperparameters_range_dictionary["epochs"] = Categorical([100])
            hyperparameters_range_dictionary["num_components"] = Integer(1, 350)
        ...
        if recommender_class is LightFMWrapper_bingeworthy:
            hyperparameters_range_dictionary = {}
            hyperparameters_range_dictionary["item_alpha"] = Real(low=1e-4, high=1e-1, prior='log-uniform')
            hyperparameters_range_dictionary["epochs"] = Categorical([100])
            hyperparameters_range_dictionary["num_components"] = Integer(1, 350)
        ...
        if recommender_class is SLIMElasticNetRecommenderBingewatcherBingeworthy:
        ...
        if recommender_class is SLIMElasticNetRecommenderBingewatcher:
        ...
        if recommender_class is SLIMElasticNetRecommenderBingeworthy:
        ...
        print(hyperparameters_range_dictionary)
