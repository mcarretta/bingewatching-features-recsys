...
@cython.cdivision(True)
@cython.overflowcheck(False)
cdef class MatrixFactorizationImpressions_Cython_Epoch:
    ...
    cdef int impression_data_flag, impression_sampling_mode_inside_flag
    ...
    IMPRESSIONS_SAMPLING_VALUES = ["inside", "outside"]
    ...
    def __init__(self, URM_train, URM_impressions = None,
        ...
        super(MatrixFactorizationImpressions_Cython_Epoch, self).__init__()
