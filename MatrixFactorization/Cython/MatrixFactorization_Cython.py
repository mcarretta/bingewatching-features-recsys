...
class _MatrixFactorization_Cython(BaseMatrixFactorizationRecommender, Incremental_Training_Early_Stopping):
    ...
    def __init__(self, URM_train, verbose = True, recompile_cython = False, algorithm_name = "MF_BPR", evaluation_block_size: int = 1):
        super(_MatrixFactorization_Cython, self).__init__(URM_train, verbose = verbose, evaluation_block_size=evaluation_block_size)
...
class MatrixFactorization_BPR_Cython(_MatrixFactorization_Cython):
    ...
    def __init__(self, *pos_args, **key_args):
        super(MatrixFactorization_BPR_Cython, self).__init__(*pos_args,
                                                             algorithm_name="MF_BPR",
                                                             evaluation_block_size=1000,
                                                             **key_args)
...
class MatrixFactorization_FunkSVD_Cython(_MatrixFactorization_Cython):
    ...
    def __init__(self, *pos_args, **key_args):
        super(MatrixFactorization_FunkSVD_Cython, self).__init__(*pos_args,
