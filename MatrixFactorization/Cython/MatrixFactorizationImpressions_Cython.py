...
class _MatrixFactorizationImpression_Cython(BaseMatrixFactorizationRecommender, Incremental_Training_Early_Stopping):
    ...
    def __init__(self,
        ...
        super(_MatrixFactorizationImpression_Cython, self).__init__(URM_train,
                                                                    verbose=verbose,
    ...
    def fit(self, epochs=300, batch_size = 1000,
        ...
        from MatrixFactorization.Cython.MatrixFactorizationImpressions_Cython_Epoch import MatrixFactorizationImpressions_Cython_Epoch


        if self.algorithm_name in ["FUNK_SVD", "ASY_SVD"]:

            self.cythonEpoch = MatrixFactorizationImpressions_Cython_Epoch(self.URM_train,
            ...
            self.cythonEpoch = MatrixFactorizationImpressions_Cython_Epoch(URM_train_positive,
...
class MatrixFactorization_BPR_Impression_Cython(_MatrixFactorizationImpression_Cython):
    """
    ...
    def __init__(self, *pos_args, **key_args):
        super(MatrixFactorization_BPR_Impression_Cython, self).__init__(*pos_args,
                                                                        algorithm_name="MF_BPR",
                                                                        evaluation_block_size=500,
                                                                        **key_args)
    ...
    def fit(self, **key_args):
        ...
        super(MatrixFactorization_BPR_Impression_Cython, self).fit(**key_args)





class MatrixFactorization_FunkSVD_Impression_Cython(_MatrixFactorizationImpression_Cython):
    """
    ...
    def __init__(self, *pos_args, **key_args):
        super(MatrixFactorization_FunkSVD_Impression_Cython, self).__init__(*pos_args, algorithm_name="FUNK_SVD", **key_args)


    def fit(self, **key_args):

        super(MatrixFactorization_FunkSVD_Impression_Cython, self).fit(**key_args)




class MatrixFactorization_AsySVD_Impression_Cython(_MatrixFactorizationImpression_Cython):
    """
    ...
    def __init__(self, *pos_args, **key_args):
        super(MatrixFactorization_AsySVD_Impression_Cython, self).__init__(*pos_args, algorithm_name="ASY_SVD", **key_args)
    ...
    def fit(self, **key_args):
        ...
        super(MatrixFactorization_AsySVD_Impression_Cython, self).fit(**key_args)
